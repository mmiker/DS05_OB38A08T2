...
//---------------------------------------------------
	...
	AUD_ID_INPUT_DEL_FP_NUM 		= AUD_ID_PRESS_FP,//请输入要删除的编号或指纹，按#键结束
	//AUD_ID_CHG_FAIL_RETRY 			= 36+AUD_BASE_ID_MAX,//修改失败，请重试
	//AUD_ID_CHG_CONTINUE_CONFIRM 	= 9+AUD_BASE_ID_MAX,//继续修改请按#，返回请按*
	//0x27
	AUD_ID_FP_NOT_EXIST 			= AUD_ID_CHECK_FAIL_RETRY,//指纹不存在，请重新输入
	//AUD_ID_DEL_FP_CONFIRM 			= 33+AUD_BASE_ID_MAX,//号指纹按#确认删除，取消请按*
	AUD_ID_PRESS_DEL_FP_AGAIN 		= AUD_ID_PRESS_FP_AGAIN,//请再按一次要删除的指纹
	AUD_ID_DEL_FP_SUCESS 			= AUD_ID_DEL_SUCCESS,//号指纹删除成功
	...
	AUD_ID_INPUT_NEW_ADMIN_PWD = AUD_ID_INPUT_NEW_PWD,//请输入新管理员密码，按#键结束
	//
	AUD_ID_INPUT_NEW_ADMIN_PWD_AGAIN 			= AUD_ID_PWD_INPUT_AGAIN,//请再次输入新管理员密码，按#键结束
	AUD_ID_CHG_ADMIN_PWD_SUCESS					= AUD_ID_SET_SUCCESS,//管理员密码修改成功
	AUD_ID_PWD_EXIST 							= AUD_ID_OPRATION_FAIL,//密码已存在，请重新输入
	...
	AUD_ID_CLOSE_PRO_AUDIO_FAIL 				= AUD_ID_OPRATION_FAIL,//关闭提示音失败
	AUD_ID_OPEN_PRO_AUDIO_FAIL 					= AUD_ID_OPRATION_FAIL,//开启提示音失败
	AUD_ID_SIN_OPEN_MODE_SUCESS 				= AUD_ID_SYS_SIN_OPEN_MODE,//单开门方式设置成功
	AUD_ID_SIN_OPEN_MODE_FAIL 					= AUD_ID_OPRATION_FAIL,//单开门方式设置失败
	AUD_ID_DBL_OPEN_MODE_SUCESS 				= AUD_ID_SYS_DBL_OPEN_MODE,//双开门方式设置成功
	AUD_ID_DBL_OPEN_MODE_FAIL 					= AUD_ID_OPRATION_FAIL,//双开门方式设置失败
	...
	AUD_ID_PWD_WRONG_TRY 						= AUD_ID_CHECK_FAIL_RETRY,//密码错误,请重试
	AUD_ID_FP_WRONG_TRY 						= AUD_ID_CHECK_FAIL_RETRY,//指纹错误，请重试
	//AUD_ID_RFCARD_WRONG_TRY 					= 60+AUD_BASE_ID_MAX,//RF卡错误，请重试
	AUD_ID_RONG_TIMES_EXCEED 					= AUD_ID_OPRATION_FAIL,//错误次数已超限制，请**分钟后重试
